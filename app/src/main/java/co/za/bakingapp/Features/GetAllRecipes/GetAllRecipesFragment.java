...
public class GetAllRecipesFragment extends Fragment {
    ...
    private void setupViews(View v) {
        ...
        RecyclerView mRecyclerView = v.findViewById(R.id.recyclerview_AllRecipes);
        ...
        GetAllRecipesViewModel getAllRecipesViewModel = ViewModelProviders.of(this, factory).get(GetAllRecipesViewModel.class);
